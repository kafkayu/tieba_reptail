...
#           '1': 'http://www.ip3366.net/free/'} # xicidaili国外http代理
...
def get_proxy():
    # API接口，返回格式为json
    api_url = "http://www.zdaye.com/ShortProxy/GetIP/?api=1234567890&akey=8a17ca305f683620&count=10&timespan=3&type=3"
